...
### 注意
所安装的PHP的版本要和下载的代码包 保持一致
### 软件来源

mysql5.6.12下载地址 http://dev.mysql.com/get/Downloads/MySQL-5.6/mysql-5.6.12-linux-glibc2.5-x86_64.tar.gz

nginx1.5.11下载地址 http://nginx.org/download/nginx-1.5.11.tar.gz

php5.4.33下载地址 http://php.net/get/php-5.4.33.tar.gz/from/a/mirror

php5.6.18下载地址 http://php.net/get/php-5.6.18.tar.gz/from/a/mirror
...
2 libmcrypt ———— 加密算法扩展库(支持DES, 3DES, RIJNDAEL, Twofish, IDEA, GOST, CAST-256, ARCFOUR, SERPENT, SAFER+等算法)
...
1 软件来源
<<<<<<< HEAD
   gd-2.0.35下载地址 https://bitbucket.org/libgd/gd-libgd/downloads
   
   freetype-2.3.5下载地址 http://download.savannah.gnu.org/releases/freetype/
=======
   gd-2.0.35下载地址 <https://bitbucket.org/libgd/gd-libgd/downloads>

   freetype-2.3.5下载地址 <http://download.savannah.gnu.org/releases/freetype/>
>>>>>>> cf7c7edca07319eaafdbd7d90dc5b2359461e9ca
...
6 解密工具 
   ...
   下载 ZendGuardLoader-php-5.6-linux-glibc23-x86_64.tar.gz
   (zend-loader-php5.6-darwin10.7-x86_64 2) http://www.zend.com/en/products/loader/downloads#Linux(安装步骤和54一样)
